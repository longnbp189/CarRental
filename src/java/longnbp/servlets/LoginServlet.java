...
public class LoginServlet extends HttpServlet {
    ...
    private final String HOME_PAGE = "search";
    private final String VALIDATE_PAGE = "validate";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result) {
                AccountDTO dto = dao.getAccountDetail(username);
                if (!dto.isStatus()) {
                ...
                session.setAttribute("LOGIN_ERROR", "Invaid username or password");
            }
